                    ...
                    <View className="m-1">
                        ...
                        {showBody && (
                            <>
                                {/* Racing */}
                                <View style={{ marginBottom: SPACING.lg }}>
                                    <SectionLabel label="Racing" right={makeResetLink(resetRacingDefaults)} />
                                    <View style={{ backgroundColor: colors.surface, borderRadius: RADII.lg, borderWidth: 1, borderColor: colors.borderHair, overflow: "hidden", padding: SPACING.md }}>
                                ...
                                {/* Energy & Resources */}
                                <View style={{ marginBottom: SPACING.lg }}>
                                    <SectionLabel label="Energy & Resources" right={makeResetLink(resetEnergyDefaults)} />
                                    <View style={{ backgroundColor: colors.surface, borderRadius: RADII.lg, borderWidth: 1, borderColor: colors.borderHair, overflow: "hidden", padding: SPACING.md }}>
                                        <View style={styles.section}>
                                            <CustomSlider
                                ...
                                {/* Training */}
                                <View style={{ marginBottom: SPACING.lg }}>
                                    <SectionLabel label="Training" right={makeResetLink(resetTrainingDefaults)} />
                                    <View style={{ backgroundColor: colors.surface, borderRadius: RADII.lg, borderWidth: 1, borderColor: colors.borderHair, overflow: "hidden", padding: SPACING.md }}>
                                        <View style={styles.section}>
                                            <CustomSlider
                                ...
                                {/* Shop & Items */}
                                <View style={{ marginBottom: SPACING.lg }}>
                                    <SectionLabel label="Shop & Items" right={makeResetLink(resetShopDefaults)} />
                                    <View style={{ backgroundColor: colors.surface, borderRadius: RADII.lg, borderWidth: 1, borderColor: colors.borderHair, overflow: "hidden", padding: SPACING.md }}>
                                        <View style={styles.section}>
                                            <CustomSlider
                                ...
                                {/* Item Conservation */}
                                <View style={{ marginBottom: SPACING.lg }}>
                                    <SectionLabel label="Item Conservation" right={makeResetLink(resetConservationDefaults)} />
                                    <View style={{ backgroundColor: colors.surface, borderRadius: RADII.lg, borderWidth: 1, borderColor: colors.borderHair, overflow: "hidden", padding: SPACING.md }}>
