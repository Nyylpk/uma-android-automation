...
const SkillSettings = () => {
    ...
    // Shared chevron icon used as the right-aligned affordance on navigation Rows.
        ...
        <View style={styles.root}>
            <SearchPageProvider page="SkillSettings" scrollViewRef={scrollViewRef}>
                ...
                >
                    ...
                    <Section label="SKILL POINT CHECK" collapsible defaultOpen>
                    ...
                    <Section label="SKILL STYLE OVERRIDES" collapsible defaultOpen>
                        <View style={styles.sectionInner}>
                            <Text style={styles.sectionIntro}>
                                Override which types of skills the bot can purchase. Any skills whose activation condition does not match the selected override will be filtered out of the list of
                                available skills that the bot can consider for purchasing. Skills that have no activation conditions will still be available.
                            </Text>
                                ...
                                <InfoContainer>
                                    <View>
                                        ...
                                        <View style={styles.infoBlock}>
                                            ...
                                            <Text style={styles.infoDescription}>
                                                • Does not filter any skills based on running style. For example, even if your trainee is an "End Closer", the bot may still purchase "Pace Chaser
                                                Corners ○" (a Pace Chaser skill) if it's available.
                                            </Text>
                                        </View>
                    ...
                    <Section label="SKILL PLANS">
                        {Object.values(skillPlanSettingsPages).map((value) => (
                            <Row
                                key={value.name}
                                title={`${value.title} Skill Plan Settings`}
